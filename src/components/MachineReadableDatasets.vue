    ...
    <div class="container">
      <div class="Search__container">
        ...
        <div class="Chart__content">
            <p style="text-align: center; width: 128px;">{{ $t("message.dashboard.machine_readability.plots.title.ratio_of_mr") }}</p>
...
export default {
  ...
  methods: {
    requestData () {
      axios.get(this.$env.ROOT_API + '/metric/global/datasets/machine_readable', {
        auth: {

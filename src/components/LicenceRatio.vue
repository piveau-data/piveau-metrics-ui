    ...
    <div class="container">
      <div class="Search__container">
        ...
        <div class="Chart__content">
            <p style="text-align: center">{{ $t("message.dashboard.licence_usage.plots.title.licence_ratio") }}</p>
...
export default {
  ...
  data () {
    return {
      ...
      licences: 'https://www.ppe-aws.europeandataportal.eu/mqa-service/metric/global/datasets/known_licences`',
  ...
  methods: {
    requestData () {
      axios.get(this.$env.ROOT_API + '/metric/global/datasets/known_licences', {
        auth: {

    ...
    <div class="container">
      <div class="Search__container">
        ...
        <div class="Chart__content">
            <p style="text-align: center"> {{ $t("message.dashboard.accessibility.plots.title.accessibility_access_url") }}</p>
             ...
             <div class="relative" v-else-if="data.success === true">
              <doughnut-chart :width="150" :height="150" v-if="loaded" :chart-data="[Math.round(data.result.yes | addPercentage), Math.round(data.result.no), Math.round(data.result.unknown)]" :chart-labels="desc"></doughnut-chart>
...
export default {
  ...
  methods: {
    requestData () {
      axios.get(this.$env.ROOT_API + `/metric/global/distributions/accessibility/access_url`, {
        auth: {
